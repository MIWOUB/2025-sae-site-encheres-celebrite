...
require_once('src/controllers/Interaction/FavoriteController.php');
require_once('src/controllers/Interaction/UnfavoriteController.php');
require_once('src/controllers/Interaction/BidController.php');
require_once('src/controllers/Interaction/CommentController.php');
require_once('src/controllers/Product/ProductRepublishController.php');
require_once('src/controllers/Page/HomeController.php');
require_once("src/controllers/Admin/NewsletterController.php");
...
try {
    if (isset($_GET['action']) && $_GET['action'] !== '') {
        ...
        if ($_GET['action'] === 'connection') {
            ...
            require_once('src/controllers/Auth/LogoutController.php');
