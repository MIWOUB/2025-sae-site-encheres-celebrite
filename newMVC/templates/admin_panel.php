...
<main>
    ...
    <div class="content">
        ...
        <div class="annonces">
            <?php $products = getAllProduct_admin();
            if (empty($products)): ?>
            ...
            <?php else: ?>
                ...
                <?php foreach ($products as $p): ?>
                    ...
                    <div class="announce-card">
                        ...
                        <p class="Categorie">Catégorie : <?php $cate = $productRepository->getCategoryFromAnnoncement($p['id_product']);
                                                            echo ($cate && isset($cate['name']) ? htmlspecialchars($cate['name']) : 'Non spécifiée'); ?></p>
                        <p class="Celebrite">Celebrite : <?php $cele = $celebrityRepository->getCelebrityFromAnnoncement($p['id_product']);
                                                            echo ($cele && isset($cele['name']) ? htmlspecialchars($cele['name']) : 'Non spécifiée'); ?></p>
