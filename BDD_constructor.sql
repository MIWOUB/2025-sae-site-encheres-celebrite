...
INSERT INTO
    `belongsto` (`id_product`, `id_category`)
VALUES (1, 1),
    (2, 8),
    (3, 4),
    (4, 6),
...
INSERT INTO
    `concerned` (`id_product`, `id_celebrity`)
VALUES (1, 2),
    (2, 6),
    (3, 3),
    (4, 5),
...
VALUES (
        ...
        '58000',
        'test@gmail.com',
        '$argon2id$v=19$m=65536,t=4,p=1$SXZsLktHM2l3UlhLSTdCeQ$IxIV3pjNBb/fOFk5PCudTrHyGS1Xdw7VeEIshnanyhg',
        0,
        0
    ),
    (
        ...
        '58000',
        'admin@gmail.com',
        '$argon2id$v=19$m=65536,t=4,p=1$b1Y2WUF1UXBCbTdyZW55Ng$LOqQ4IgcRdKmKzCwhUKrgn5afyfZUDP83FepnbOIrVQ',
        0,
        1
    ),
    (
        ...
        'blablabla',
        '58000',
        'jimmygarnier11@outlook.fr',
        '$argon2id$v=19$m=65536,t=4,p=1$ejJQRGFFY3IzU2NSVy9pdA$ITH3RZq/iaKL/tAa0xlO2v4kjhIpRwATHxhZVfKuZ2Y',
        0,
        0
    );
